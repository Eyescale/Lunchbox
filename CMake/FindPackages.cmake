...
if(DNSSD_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND LUNCHBOX_DEPENDENT_LIBRARIES DNSSD)
  endif()
...
if(avahi-client_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND LUNCHBOX_DEPENDENT_LIBRARIES avahi-client)
  endif()
...
set(LUNCHBOX_DEPENDS hwloc;DNSSD;avahi-client;OpenMP;MPI;leveldb;skv;Boost)
